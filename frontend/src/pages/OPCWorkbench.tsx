            ...
            <CardContent className="flex-1 overflow-y-auto py-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="ml-11 bg-violet-500/10 border border-violet-500/20 p-4 rounded-2xl rounded-tl-none text-slate-300 text-sm leading-relaxed">
                  <span className="text-violet-300">@所有人</span>{" "}
                  本周需要发布一篇关于"AI Native 一人公司趋势"的深度文章。
                  <br />
                  <br />
                  <span className="text-blue-300">@战略分析师</span>{" "}
                  先做行业趋势扫描，找出3个关键洞察
                  <br />
                  <span className="text-cyan-300">@研究助理</span>{" "}
                  搜集最近一个月的相关案例和数据
                  <br />
                  <span className="text-amber-300">@内容创作师</span>{" "}
                  等前两位完成后，基于素材撰写2500字文章
                  <br />
                  <span className="text-pink-300">@设计排版师</span>{" "}
                  文章完成后制作封面和3张信息图
                  <br />
                  <span className="text-emerald-300">@社媒运营官</span>{" "}
                  最后拆解为小红书/即刻/公众号三个版本
                </div>
              </div>
            ...
            <CardHeader className="pb-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                {teamStats.map((stat) => (
                  <div
                    key={stat.label}
                    className="bg-[#1e1f2e] border border-slate-800 p-4 rounded-xl text-center"
                  >
