    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <Link to="/" className="lg:hidden flex items-center gap-2 group">
          ...
          <span className="font-semibold text-[var(--text-primary)] text-lg tracking-tight">OPC</span>
        </Link>
      </div>
          ...
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <div className="hidden sm:flex flex-col items-start text-left">
                <span className="text-sm font-medium text-[var(--text-primary)] leading-tight">{user.name}</span>
                <span className="text-xs text-[var(--text-muted)] leading-tight">{user.role}</span>
              </div>
